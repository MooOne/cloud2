...
z-index: 999999">
        <img src="{{asset('assets/img/loader.gi')}}f" style=" width: 40px;" alt="loading...">
    </div>
</div>
        ...
        <div id="content" class="bg-container">
            <header class="head">
                <div class="main-bar">
                    <div class="row">
                        <div class="col-lg-5">
                            <h4 class="nav_top_align"><i class="fa fa-th"></i> Boxed and Fixed Header</h4>
                        </div>
                        <div class="col-lg-7">
                            <ul class="breadcrumb float-right nav_breadcrumb_top_align">
                                ...
                                <li class="breadcrumb-item active">Boxed and Fixed Header</li>
                            </ul>
                        </div>
                    </div>
                </div>
