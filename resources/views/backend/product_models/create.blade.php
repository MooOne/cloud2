                    ...
                    <div class="form-group {!! !$errors->has('model_name') ? '' : 'has-error' !!}">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="model_name" name="model_name" value="" class="form-control model_name" placeholder="{{ trans('backend.input') }} {{ $columns['model_name'] }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group {!! !$errors->has('code') ? '' : 'has-error' !!}">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="code" name="code" value="" class="form-control code" placeholder="{{ trans('backend.input') }} {{ $columns['code'] }}">
                            </div>
                        </div>
                    </div>
                    {{--Fields code End--}}
                    ...
                    <div class="form-group {!! !$errors->has('status') ? '' : 'has-error' !!}">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="status" name="status" value="" class="form-control status" placeholder="{{ trans('backend.input') }} {{ $columns['status'] }}">
                            </div>
                        </div>
                    </div>
                    {{--Fields status End--}}
