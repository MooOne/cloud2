        ...
        <div class="box">
                                ...
                                <form action="{{ url_without_filters($columns)}}" method="get" pjax-container>
                                    <div class="modal-body">
                                        <div class="form">
											...
											<div class="form-group">
                    							<div class="form-group">
                        							...
                        							<div class="input-group">
                            							...
                            							<input type="text" class="form-control title" placeholder="{{ $columns['title'] }}" name="title" value="{{ isset($query['title']) ? $query['title'] : ''}}">
                        							</div>
                    							</div>
                							</div>
											...
											<div class="form-group">
                    							<div class="form-group">
                        							<label>{{ $columns['model_name'] }}</label>
                        							<div class="input-group">
                            							<div class="input-group-addon">
                                							<i class="fa fa-pencil"></i>
                            							</div>
                            							<input type="text" class="form-control model_name" placeholder="{{ $columns['model_name'] }}" name="model_name" value="{{ isset($query['model_name']) ? $query['model_name'] : ''}}">
                        							</div>
                    							</div>
                							</div>
											...
											<div class="form-group">
                    							<div class="form-group">
                        							<label>{{ $columns['code'] }}</label>
                        							<div class="input-group">
                            							<div class="input-group-addon">
                                							<i class="fa fa-pencil"></i>
                            							</div>
                            							<input type="text" class="form-control code" placeholder="{{ $columns['code'] }}" name="code" value="{{ isset($query['code']) ? $query['code'] : ''}}">
                        							</div>
                    							</div>
                							</div>
											...
											<div class="form-group">
                    							<div class="form-group">
                        							...
                        							<div class="input-group">
                            							...
                            							<input type="text" class="form-control status" placeholder="{{ $columns['status'] }}" name="status" value="{{ isset($query['status']) ? $query['status'] : ''}}">
                        							</div>
                    							</div>
                							</div>
            ...
            <div class="box-body table-responsive no-padding">
                <table class="table table-hover">
                    <tr>
                        <th></th>
                        <th>{{ $columns['product_model_id'] }}{!! column_sorter('product_model_id') !!}</th>
                        <th>{{ $columns['title'] }}</th>
                        <th>{{ $columns['model_name'] }}</th>
                        <th>{{ $columns['code'] }}</th>
                    ...
                    @foreach($lists['data'] as $row)
                        <tr>
                            <td>
                                <input type="checkbox" class="grid-row-checkbox" data-id="{{ $row['product_model_id'] }}" />
                            </td>
                            <td>{{ $row['product_model_id'] }}</td>
                            <td>{{ $row['title'] }}</td>
                            ...
                            <td>
                                <a href="{{ get_resource() }}/{{ $row['product_model_id'] }}/edit">
                                    <i class="fa fa-edit"></i>
                                </a>
                                <a href="javascript:void(0);" data-id="{{ $row['product_model_id'] }}" class="grid-row-delete">
