                        ...
                        <div class="form-group {!! !$errors->has('email') ? '' : 'has-error' !!}">
                            ...
                            <div class="col-sm-8">
                                ...
                                <span class="input-group-addon">
                                    ...
                                    <input type="text" id="email" name="email" value="" class="form-control email" placeholder="{{ trans('backend.input') }} {{ $columns['email'] }}">
                                </div>
                            </div>
                        </div>
                        {{--Fields End--}}
                    ...
                    <div class="fields-group">
                        ...
                        <div class="form-group {!! !$errors->has('gender') ? '' : 'has-error' !!}">
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="radio">
                                    <label >
                                        <input type="radio" name="gender" value="F" class="minimal gender" checked />&nbsp;F&nbsp;
                                    </label>
                                    <label >
                                        <input type="radio" name="gender" value="M" class="minimal gender" />&nbsp;M&nbsp;
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group {!! !$errors->has('birthday') ? '' : 'has-error' !!}">
                            ...
                            <div class="col-sm-8">
                                ...
                                <span class="input-group-addon birthday">
                                    ...
                                    <input type="text" style="width: 110px" id="birthday" name="birthday" value="" class="form-control birthday" readonly placeholder="{{ trans('backend.choose') }} {{ $columns['birthday'] }}">
                                </div>
                            </div>
                        </div>
                        {{--Fields End--}}
                        ...
                        <div class="form-group {!! !$errors->has('phone_number') ? '' : 'has-error' !!}">
                            ...
                            <div class="col-sm-8">
                                ...
                                <span class="input-group-addon">
                                    ...
                                    <input type="text" id="phone_number" name="phone_number" value="" class="form-control phone_number" placeholder="{{ trans('backend.input') }} {{ $columns['phone_number'] }}">
                                </div>
                            </div>
                        </div>
                        {{--Fields End--}}
                    ...
                    <div class="fields-group">
                        ...
                        <div class="form-group {!! !$errors->has('status') ? '' : 'has-error' !!}">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input type="checkbox" id="status" name="status" value="1" class="status la_checkbox" checked />
